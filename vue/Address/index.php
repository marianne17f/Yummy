	...
	<div class="blog address">
		<div class="container">
			...
			<div class="text-center">
				<a href="<?php echo WEBROOT ?>Address/pageAddAddress" class="btn btnD1 btn_creation" data-aos="fade-up" data-aos-delay="450" data-aos-duration="1000" data-aos-once="true">Créer une nouvelle bonne adresse</a>		
			</div>	
